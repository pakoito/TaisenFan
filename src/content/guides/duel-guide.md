...
DUEL has no deck restrictions. You can bring whatever 8-cost deck you want to every stage. Battles are scored based on performance, and S-rank clears award special titles.
...
| Achievement | Reward |
|-------------|--------|
| View all Tutorials | 6 DS-original cards from the previous game |
| Complete Normal | EX Wang Yi, EX Xu Chu, EX Xu Huang, Yellow soldier color, Hard unlocks |
| Complete Hard | DS Sima Yi, Purple soldier color, Extreme unlocks |
| Complete Extreme | "Unrivaled" (天下無双) title, Light Blue soldier color |
| All Mastery MASTER | "Grand Master" (総師範) title, DS Taishi Ci |

### Difficulty Progression

| Difficulty | Japanese | Stages | Notes |
|------------|----------|--------|-------|
| Normal | 普 | 20 | Available from start |
| Hard | 難 | 40 | Unlocks after Normal |
| Extreme | 激 | 20 | Unlocks after Hard |

The S-rank point threshold varies by difficulty. Normal and Hard are achievable with strong standard decks, but Extreme demands specific counter-strategies for each enemy army.

---

## Mastery System

Battle performance fills mastery gauges based on your actions. When a gauge reaches MASTER rank, you earn a permanent title:

| Mastery Type | Title (English) | Title (Japanese) |
|--------------|-----------------|------------------|
| Horse | Charge King | 突撃王 |
| Spear | Thrust King | 槍撃王 |
| Bow | Run Shot King | 走射王 |
| Defeat | Defeat King | 撃破王 |
| Siege | Siege King | 攻城王 |
| Defense | Guardian | 守護神 |
| Duel | Brawl King | 喧嘩王 |
| **All MASTER** | **Grand Master** | **総師範** |

Achieving Grand Master also rewards **DS Taishi Ci (DS13)**, making it worth grinding out every mastery type.

### Mastery Grinding Tips

| Mastery | What to Do |
|---------|------------|
| Horse | Use Horse units, land Charges |
| Spear | Use Spear units, land Thrusts |
| Bow | Use Bow units, land shots while moving |
| Defeat | Kill enemy units |
| Siege | Deal castle damage |
| Defense | Protect your castle |
| Duel | Win duels (risky - only duel with POW advantage) |

Normal difficulty is fine for grinding. You don't need to S-rank for mastery progress.

---

## Scoring System

S-rank requires **30,000+ points** (threshold varies slightly by difficulty). Points come from:

1. **Castle HP Remaining** - How much of your own castle survives
2. **Enemy Castle Damage** - How much you reduce their castle
3. **Kill/Death Ratio** - Units destroyed without losing your own
...
**Rewards:** EX Wang Yi, EX Xu Chu, EX Xu Huang, Yellow soldier color

All 20 stages. The difficulty is low. Experienced players can S-rank everything on their first try.

If you're new, don't worry about losses. There's no penalty, and you learn more from losing than winning.
...
| 14 | Guan Yu Army | UC Guan Yu, C Wang Ping, UC Zhou Cang, C Meng Da | Brave General |
...
**Rewards:** DS Sima Yi, Purple soldier color
...
- Early stages can be rushed with opening attack decks, but late stages require proper counter-decks.
- Enemy compositions often mix unit types, so you can't rely on type advantage alone. Think about which skills to build your deck around.
- Once you can build decks that counter specific compositions, the difficulty becomes manageable.
- "Heroes and Daughters" and "Fierce Warriors Alliance" are nearly as hard as Extreme stages.
...
## Extreme Difficulty (激)

**Rewards:** "Unrivaled" (天下無双) title, Light Blue soldier color

All 20 stages. Even experienced players will struggle to clear everything with one deck. You must tailor your deck to each stage.
...
### Stage 1: Western Heroes

**Enemy Units:** SR Ma Chao, SR Lu Bu, R Zhang Liao, R Pang De  
**Formation:** Front line, horizontal spread  
**Title:** Western Champion

**Strategy:** [Horse Fool Ambush](deck-strategies.md#strategy-6-horse-fool-ambush)
...
### Stage 2: Sima Yi Couple

**Enemy Units:** SR Sima Yi, SR Zhang Chunhua, R Jia Xu (Wei), UC Yu Jin, R Zhang He, C Cao Hong, SR Deng Ai  
**Formation:** R Zhang He and C Cao Hong visible; all others are Ambush  
**Title:** Grand Strategist

**Strategy:** [Opening Rush](deck-strategies.md#strategy-8-opening-rush) with Lei Bo

Approach from either side. Position Inferno so the edge touches the inner vertical line of the enemy tower. Priority target is Sima Yi - force him out of Ambush. Yu Jin's Ambush will hit you late, but by then the match is decided.

During your advance, try to match Zhang Fei's Charge against Deng Ai's Charge for an ideal trade.

**Alternative:** [Yellow Chain](deck-strategies.md#strategy-5-yellow-chain) - kill Cao Hong first to prevent flanking bow fire before using Chain.
...
**Title:** Supreme Wisdom

**Strategy:** [Yellow Chain](deck-strategies.md#strategy-5-yellow-chain)

Three high-INT Ambush units make direct engagement suicidal. Use Huang Yueying's siege rush to bypass them entirely. Never enter enemy territory with anyone except Huang Yueying. Fight only visible enemies near your territory, then rush the castle with Yellow Accel and Iron Chain.
...
### Stage 5: Siege Camp Army

**Enemy Units:** R Gao Shun, R Hua Xiong, UC Chen Gong, C Zhang Xiu, UC Ji Ling, C Pei Yuanshao  
**Formation:** Fences on left side  
**Title:** Siege Camp

**Strategy:** [Elite Opening](deck-strategies.md#strategy-7-elite-opening)

**Sample Deck:** UC Guan Ping, R Zhang Fei, C Zhang Liang, C Chen Lan, UC Gan Ning (all Man affinity), Sage: SR Zhuge Liang
...
If Gao Shun breaks off to siege your castle mid-fight, it actually helps by preventing Rally.

**Alternative:** Opening Long Spear also works. Position Chen Lan on the right edge.
...
**Title:** Treacherous Hero

**Strategy:** [Opening Rush](deck-strategies.md#strategy-8-opening-rush)

Attack from the right side where Cao Ren is positioned. Position Inferno anywhere in center that doesn't block your advance.
...
### Stage 9: Unrivaled Army

**Enemy Units:** SR Lu Bu, R Lu Lingqi, UC Chen Gong, R Gao Shun, R Zhang Liao  
...
**Key Timing:** Chen Gong moves forward for just a few counts at battle start - don't miss your chance to trigger his Ambush reveal.

After all enemies die to Ambush, return revealed units to your castle. Send Chen Lan alone to the castle gate with Lance Tactics - 2 hits will win.
...
**Title:** Nation-Toppling Beauty

**Strategy:** [Elite Opening](deck-strategies.md#strategy-7-elite-opening)

Attack from the right. Activate Rally Elite just before contact.

High chance Hua Xiong triggers a duel - winning it leaves only 5 POW enemies, making the rest easy.

Trigger the Ambush with Guan Ping.

**Watch Out:** Li Ru's Poison. With many Charm units, he can cast it as early as count 10. Getting poisoned is usually fine, but if you haven't landed any siege damage yet, it becomes critical.
...
**Complication:** Xiahou Dun has the Undying trait, making timing critical.

Position Deception in center. After defeating all units, keep revealed Ambush units waiting. Send Chen Lan alone to castle gate with Lance Tactics.

Carefully time your siege hits - if you mistime the second hit, Xiahou Dun revives and blocks it.
...
Defeating enemies is easy, but Rally is dangerous. Consider staggering Deception activations and letting wounded enemies retreat for better efficiency.
...
**Strategy:** [Opening Long Spear](deck-strategies.md#strategy-4-opening-long-spear)

Position formation forward to reach bow units. Place units in center with Chen Lan as decoy in back center. This positioning draws the side Ambush units toward the fence area.

After Spear Flash activates, defeat as many as possible. Then move Chen Lan horizontally to the right edge and use Lance Tactics for wall siege.

Move spear units left for wall siege while avoiding the Ambush units gathering near the fences.

---

### Stage 17: Hero Couples

**Enemy Units:** SR Cao Cao, R Liu Bei, SR Sun Jian, SR Lu Bu, UC Lady Bian, C Lady Mi, SR Lady Wu, UC Yan  
**Formation:** Fences on right with Lady Bian and Yan behind, Cao Cao in front; rest on left  
**Title:** Happy Marriage

**Strategy:** Special - Use Enemy's Field Dance

The enemy has C Lady Mi who will cast Field Dance, so you don't need to bring your own.

Enemy dance order follows this priority: Inspire Dance → Field Dance → Ruin Dance. Dances won't cast if the dancer is dead.

Enemy also has Sunset Dance (Lady Bian) which activates when you're at their castle.
...
**Title:** Tiger Incarnation

**Strategy:** [Ambush Lance](deck-strategies.md#strategy-2-ambush-lance) with Reinforce or Link Force

**Sample Deck:** C Chen Lan, SR Zhang Chunhua, SR Deng Ai, R Jia Xu (Wei), UC Kuai Yue, C Lu Fan, C Zhang Xiu, Sage: Mi Heng (Reinforce)

This is the hardest Extreme stage. The center damage terrain makes it even worse. Defeating enemies is easy - the challenge is scoring S-rank.

**Enemy Movement:** Left group (Lu Bu, Xiahou Yuan, Cao Zhang) and right group (Pang De, Hu Cheer, Zhang Liang) advance first. Dian Wei and Xu Chu follow as rear guard.

**Initial Setup:** Stack on right side. Front row: SR Zhang Chunhua, SR Deng Ai, C Zhang Xiu. Middle row: UC Kuai Yue, C Lu Fan, C Chen Lan. Back row: R Jia Xu in left column.

**Execution:**
1. Keep front row stationary. Move Lu Fan forward
2. Shift Kuai Yue and Jia Xu left to intercept Lu Bu and Cao Zhang routing around the damage terrain
3. Chen Lan waits
...
**Note:** Sometimes 2 Ambush units trigger simultaneously due to enemy clustering. If this happens, reset.
...
**Title:** Guardian of Wu

**Strategy:** [Grand Meteor](deck-strategies.md#strategy-1-grand-meteor)
...
**Sample Deck:** R Hua Xiong, R Zhang Fei, UC Ling Tong, C Chen Lan, Sage: C Fa Zheng

18-cost enemy army is absurd, but this strategy can score 40,000+ points.

Completely ignore Xu Shu on the left edge. Attack from the right. Position Chen Lan on the right rear.

Activate Formation immediately, then advance Chen Lan. Eliminate enemies. SR Ma Chao and UC Huang Zhong will often break off to siege your castle mid-fight - this actually helps.

Trigger Zhuge Liang's Ambush with Ling Tong. (Swap to R Jiang Wei or DS SR Jiang Wei for better INT resistance if desired.) Even if Ling Tong dies, the fight remains easy.

When Chen Lan approaches siege range, Ma Chao and Huang Zhong return - defeat them.

Around Chen Lan's second siege attempt, SR Zhao Yun (Undying) emerges. Bait him by sending 2 spear units to right wall and castle gate.

**Watch Out:** If you struggle to kill Huang Zhong, he heals to 200%. Keep pressure on him.
...
*Guide compiled from Japanese wiki sources (atwiki.jp/taisendsten) and gameplay analysis.*
